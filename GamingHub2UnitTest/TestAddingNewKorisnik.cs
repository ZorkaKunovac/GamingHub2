...
namespace GamingHub2UnitTest
{
    public class TestAddingNewKorisnik
    {
        ...
        [Theory]
        [InlineData("zorka.kunovac@hotmail.com", "+38761000111", "ZorkaKunovac4", "Mostar2022!", "Mostar2022!", new byte[] { 0 })]
        [InlineData("zorka.kunovac@hotmail.com", "+38761000111", "ZorkaKunovac2", "Mostar2022!", "Mostar2022!", new byte[] { 0 })]
        [InlineData("zorka.kunovac@hotmail.com", "+38761000111", "ZorkaKunovac3", "Mostar2022!", "Mostar2022!", new byte[] { 0 })]
        [InlineData("zorka.kunovac@hotmail.com", "+38761000114", "ZorkaKunovac4", "Mostar2022!", "Mostar2022!", new byte[] { 0 })]
        [InlineData("zorka.kunovac2@hotmail.com", "+38761000112", "ZorkaKunovac4", "Mostar2022!", "Mostar2022!", new byte[] { 0 })]
        public void AddKorisnik_Email_ShouldButNotWork(string email, string telefon, string korisnickoime, string password, string passwordpotvrda, byte[] slika)
        {
            KorisniciUpsertRequest request = new KorisniciUpsertRequest()
            {
                Ime = "Zorka",
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
             .UseInMemoryDatabase(databaseName: "KorisnikContext20")
             .Options;
        ...
        //[Theory]
        //[InlineData("Zorka", "Kunovac", "zorka@hotmail.com", "+38761000111", "ZorkaKunovac", "Mostar2022!", "Mostar2022!", new byte[] { 0 }, "Email")]
        ////[InlineData("Zorka", "Kunovac", "ZORKA@hotmail.com", "+38761000111", "ZorkaKunovac", "Mostar2022!", "Mostar2022!", new byte[] { 0 }, "Email")]
        ////[InlineData("Zorka", "Kunovac", "zorka.kunovac2@hotmail.com", "+38761000111", "ZorkaKunovac2", "M0$t", "M0$t", new byte[] { 0 }, "Password")]
        ////[InlineData("Zorka", "Kunovac", "zorka.kunovac3@hotmail.com", "+38761000111", "ZorkaKunovac3", "mostarMOSTAR", "mostarMOSTAR", new byte[] { 0 }, "Password")]
        ////[InlineData("Zorka", "Kunovac", "zorka.kunovac4@hotmail.com", "+38761000111", "ZorkaKunovac4", "14253536577568", "14253536577568", new byte[] { 0 }, "Password")]
